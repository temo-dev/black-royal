...
const MenuCard = (props: MenuCardPropsTypes) => {
    const { menu } = props;
    return (
        <Card shadow="sm" component="a" style={{ width: '128px', height: '158' }} radius="md" href={`#menu-${menu.id}`}>
            <Card.Section>
                <Image src={menu.background} h={102} w={126} alt="black-royal" fit="initial" radius="md" />
            </Card.Section>
